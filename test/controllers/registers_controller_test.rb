...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { email_id: @register.email_id, encrypted_password: @register.encrypted_password, username: @register.username }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { email_id: @register.email_id, encrypted_password: @register.encrypted_password, username: @register.username }
    assert_redirected_to register_path(assigns(:register))
  end
